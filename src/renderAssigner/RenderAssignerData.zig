const PendingBufDeletion = @import("../renderGraph/components.zig").PendingBufDeletion;
const PendingTexDeletion = @import("../renderGraph/components.zig").PendingTexDeletion;
...
pub const RenderAssignerData = struct {
    // Key Pools
