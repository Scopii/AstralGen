...
// Textures
pub const quantTex = TextureMeta.create(.{ .id = .{ .val = 5 }, .mem = .Gpu, .typ = .Color, .width = 1920, .height = 1080, .update = .Recreation }); // Can be Overwrite?
pub const quantDepthTex = TextureMeta.create(.{ .id = .{ .val = 11 }, .mem = .Gpu, .typ = .Depth, .width = 1920, .height = 1080, .update = .Recreation }); // Can be Overwrite?
