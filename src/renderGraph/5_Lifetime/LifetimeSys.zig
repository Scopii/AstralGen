...
pub const LifetimeSys = struct {
    pub fn assign(lifetimeData: *LifetimeData, optimizerData: *const OptimizerData, accessData: *const AccessData, registry: *const RenderRegistryData) !void {
        ...
        if (rc.FRAME_GRAPH_DEBUG) {
            ...
            for (0..lifetimeData.passLifetimes.getLength()) |i| {
                ...
                const earliestName = try registry.getPassName(earliestPass);
                const latestName = try registry.getPassName(latestPass);
