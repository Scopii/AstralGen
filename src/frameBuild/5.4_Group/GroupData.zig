...
pub const GroupData = struct {
    ...
    bufShareIndexMap: LinkedMap(u16, rc.BUF_MAX, u16, rc.BUF_MAX, 0) = .{}, // key: Group Root ID, element: sharedBufLifetime Index
    texShareIndexMap: LinkedMap(u16, rc.TEX_MAX, u16, rc.TEX_MAX, 0) = .{}, // key: Group Root ID , element: sharedTexLifetime Index
